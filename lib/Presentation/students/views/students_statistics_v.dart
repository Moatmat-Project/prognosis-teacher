...
// class StudentsStatisticsView2 extends StatefulWidget {
//   ///
//   const StudentsStatisticsView2({
//     super.key,
...
//   @override
//   State<StudentsStatisticsView2> createState() => _StudentsStatisticsView2State();
// }

// class _StudentsStatisticsView2State extends State<StudentsStatisticsView2> {
//   bool _isLoading = true;
//   GetMyStudentsStatisticsResponse? _getMyStudentsResultsResponse;
//   @override
//   void initState() {
//     loadStatistics();
//     super.initState();
...
//     final response = await locator<GetMyStudentsResultsUc>().call(
//       studentsIds: widget.students.map((e) => e.id).toList(),
//       testsIds: widget.students.map((e) => e.id).toList(),
//       setsIds: widget.students.map((e) => e.id).toList(),
//     );
//     response.fold(
//       (l) {
//         Fluttertoast.showToast(msg: l.toString());
//         _getMyStudentsResultsResponse = null;
//       },
//       (r) {
//         _getMyStudentsResultsResponse = r;
//       },
//     );
...
//       ),
//       body: !_isLoading || _getMyStudentsResultsResponse != null
//           ? _ContentBuilderWidget(
//               response: _getMyStudentsResultsResponse!,
//             )
//           : Center(
