...
class BankAnswersPercentage extends StatefulWidget {
  const BankAnswersPercentage({
    super.key,
  ...
  @override
  State<BankAnswersPercentage> createState() => _BankAnswersPercentageState();
}

class _BankAnswersPercentageState extends State<BankAnswersPercentage> {
              ...
              itemBuilder: (context, index) {
                return Center(
                  child: Column(children: [
                    QuestionItemWidget(question: widget.bank.questions[index]),
                    ...List.generate(
                      ...
                      (i) {
                        ...
                        return Container(
                          ...
                          child: Column(
                            children: [
                              AnswerBodyWidget(
                                answer: widget.bank.questions[index].answers[i],
                              ),
                              const SizedBox(height: SizesResources.s2),
                              Text("%${(p * 100).toStringAsPrecision(2)}")
                            ],
                          ),
                        );
                      },
