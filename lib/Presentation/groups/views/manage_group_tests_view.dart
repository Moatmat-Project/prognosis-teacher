...
class ManageGroupTestsInitialView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: state.canSaving
          ? SafeArea(
              child: Row(
          ...
          : null,
      body: state.selectedTests.isEmpty
          ? Center(
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _TestTileWidget(
                  dismissible: true,
                  test: state.selectedTests[index],
                  selected: state.selectedTests.contains(state.selectedTests[index]),
                  onSelect: () {
                    locator<ManageGroupTestsBloc>().add(ManageGroupTestsAddTestEvent(state.selectedTests[index]));
                  },
                  onUnSelect: () {
                    locator<ManageGroupTestsBloc>().add(ManageGroupTestsRemoveTestEvent(state.selectedTests[index]));
                  },
                );
              },
            ),
